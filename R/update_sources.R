...
library("archive")
library("seasonal")
setwd("C:/Users/Fernando.Cantu/Desktop/Nowcast/03 Code and data/Quarterly variables/Updates")

catalogue <- read_excel("Catalogue.xlsx")
n_groups <- catalogue %>% slice(n()) %>% pull(download_group)
country_conv <- read_excel("Country codes.xlsx")
